    ...
    <div className="bg-white/4 border border-white/8 rounded-2xl p-6 mb-5">
      ...
      <div
        ...
        className={[
          ...
          file ? "border-white/20 cursor-default p-4" : "cursor-pointer p-8 text-center",
          isDragging ? "border-blue-500 bg-blue-500/6" : "border-slate-600/60 hover:border-slate-500",
        ].join(" ")}
      >
        <input
          ref={fileInputRef}
        ...
        {file ? (
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm font-medium text-slate-400">Drag & drop your document here</p>
      ...
      <div className="flex items-end gap-4 flex-wrap">
        <div className="flex flex-col gap-1.5 flex-1 min-w-27.5">
          <label className="text-[11px] font-semibold text-slate-500 tracking-widest uppercase">Slides</label>
          <select
            value={slideCount}
          ...
          >
            ...
            <option value="5" className="bg-slate-900">5 slides</option>
            <option value="10" className="bg-slate-900">10 slides</option>
            <option value="15" className="bg-slate-900">15 slides</option>
          </select>
        </div>

        <div className="flex flex-col gap-1.5 flex-1 min-w-32.5">
          <label className="text-[11px] font-semibold text-slate-500 tracking-widest uppercase">Tone</label>
          <select
            value={tone}
